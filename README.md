...
第2回試作で、改良版クラムシェル型を使って **4色の Octocat バスボムが綺麗に外れて成功** しました 🐱✨
GitHub を退職する同僚（元 Microsoft 社員）への餞別ギフトとして、Microsoft ロゴカラー（赤・緑・青・黄）の 4 色 Octocat バスボムを製作し、マリオの「はてなブロック」風 3D プリント箱に詰めて贈りました。
...
詳しい製作工程・写真・学びは [`experiments/2026-05-06-trial-02/`](experiments/2026-05-06-trial-02/) を参照。
...
The redesigned clamshell mold worked! **Four Octocat bath bombs released cleanly from the mold** 🐱✨
They were made as a farewell gift for a colleague leaving GitHub (formerly at Microsoft) — cast in
the **Microsoft logo colors (red, green, blue, yellow)** and packed into a 3D-printed
...
process, photos and lessons learned.
